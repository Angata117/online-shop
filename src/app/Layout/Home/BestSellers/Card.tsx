...
//         {product.sale ? (
//           <p
//             className="font-roboto text-[12px] leading-[18px] text-center text-[#DE3618] 
//     bg-[#DE3618] bg-opacity-15 rounded-lg py-2 px-3 uppercase font-bold"
//           >
//             {product.sale}
//           </p>
//         ) : (
...
//       <p className="font-roboto font-bold text-base leading-[22px] text-[#161D25] mt-2">{product.title}</p>
...
const Card = (product: {
  ...
  return (
    <article className="flex flex-col justify-center w-fit group p-5 rounded-xl relative hover:shadow-lg">
      <div className="flex flex-row justify-between items-center ">
        {product.sale ? (
